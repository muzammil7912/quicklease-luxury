...
const Section4 = () => {
    ...
    const data = {
        ...
        ru: [
            {
                review: "Арендовать автомобиль было так просто! Процесс бронирования прошёл быстро, и машину доставили прямо в мой отель. Отличный сервис и отличные цены!",
                name: "Джеймс Р., ОАЭ",
                user: avatar
            },
            {
                review: "Команда помогла мне выбрать идеальную машину для моей поездки. Весь процесс аренды прошёл без проблем — автомобиль был в идеальном состоянии.",
                name: "Аиша М., ОАЭ",
                user: user1
            },
            {
                review: "Этот опыт аренды выделяется среди всех предыдущих — лучший из всех. Никаких скрытых платежей, удобное бронирование и отличный выбор автомобилей.",
                name: "Омар К., Саудовская Аравия",
                user: user
            },
            {
                review: "Отличный выбор автомобилей по доступным ценам. Услуги по доставке и возврату машины сделали всё очень удобным. Обязательно воспользуюсь снова!",
                name: "София Л., Германия",
                user: user
            }
        ],
