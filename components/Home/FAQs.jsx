...
const FAQs = () => {
  ...
  const data = {
    ...
    ru: [
      {
        question: "Какие документы нужны для аренды автомобиля класса люкс?",
        answer: "Резиденты ОАЭ могут арендовать автомобили класса люкс при наличии действующих водительских прав и удостоверения личности Emirates ID. Посетители должны предъявить паспорт, визу и международное водительское удостоверение (IDP).",
      },
      {
        question: "Требуется ли залог при аренде автомобиля класса люкс?",
        answer: "Да, при аренде автомобиля класса люкс требуется залог, который возвращается арендатору. Размер залога зависит от типа автомобиля и продолжительности аренды.",
      },
      {
        question: "Могу ли я арендовать автомобиль класса люкс без кредитной карты?",
        answer: "Компании по аренде автомобилей класса люкс требуют использовать кредитную карту как для оплаты, так и для залога. Однако вы можете связаться с нами напрямую для обсуждения альтернативных способов оплаты, которые могут быть доступны.",
      },
      {
        question: "Есть ли ограничения по пробегу при аренде автомобилей класса люкс?",
        answer: "Да, аренда автомобилей класса люкс предполагает ограничение суточного пробега. Превышение лимита оплачивается отдельно. Всегда внимательно изучайте условия аренды перед бронированием.",
      },
      {
        question: "Предлагаете ли вы доставку и возврат автомобилей класса люкс?",
        answer: "Безусловно! Мы предоставляем услуги доставки и возврата до двери, чтобы сделать ваш опыт максимально удобным и комфортным.",
      }
    ],
